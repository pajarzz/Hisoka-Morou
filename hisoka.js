...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
    try {
		...
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":`© Fajar Rifandi`, "h": `Hmm`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': `© Fajar Rifandi`, 'jpegThumbnail': global.fake}}}
